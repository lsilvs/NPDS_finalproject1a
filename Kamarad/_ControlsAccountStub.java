...
public class _ControlsAccountStub extends org.omg.CORBA.portable.ObjectImpl implements Kamarad.ControlsAccount
{
  ...
  public Kamarad.Account buyExtraOprion (int number, int option)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("buyExtraOprion", true);
                $out.write_long (number);
                ...
                return buyExtraOprion (number, option        );
            } finally {
                _releaseReply ($in);
            }
  } // buyExtraOprion
